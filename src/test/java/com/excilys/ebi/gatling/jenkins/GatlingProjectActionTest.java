...
public class GatlingProjectActionTest{
    ...
    public void test_with_build(){
        ...
        List<String> graphiteGraphUrls = projectAction.getGraphiteGraphUrlsForBuildHistory();
    ...
    public void test_no_builds(){
        ...
        Assert.assertEquals(0, projectAction.getGraphiteGraphUrlsForBuildHistory().size());
    }
