...
public class GraphiteGraphSettingsBuilderTest {
    ...
    private ArrayList<GraphiteGraphSettings> getListGraphiteSettings(String brand, String env, String pool) {
        ...
        gcMarkSweepHeapSetting.setTitle(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ConcurrentMarkSweep.heapUsagePercentage");
        ...
        gcMarkSweepTimeSetting.setTarget(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ConcurrentMarkSweep.collectionTime");
        gcMarkSweepTimeSetting.setTitle(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ConcurrentMarkSweep.collectionTime");
        ...
        gcParNewHeapSetting.setTarget(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ParNew.heapUsagePercentage");
        gcParNewHeapSetting.setTitle(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ParNew.heapUsagePercentage");
        ...
        gcParNewTimeSetting.setTarget(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ParNew.collectionTime");
        gcParNewTimeSetting.setTitle(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ParNew.collectionTime");
    ...
    private ArrayList<GraphiteGraphSettings> getListGraphiteSettingsPoolWithSupplemental(String brand, String env, String pool) {
        ...
        gcMarkSweepHeapSettingNormal.setTarget(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ConcurrentMarkSweep.heapUsagePercentage");
        gcMarkSweepHeapSettingNormal.setTitle(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ConcurrentMarkSweep.heapUsagePercentage");
        ...
        gcMarkSweepHeapSettingSupplemental.setTarget(brand + "." + env + ".host." + treStatsSuppPoolShotName + ".*.GarbageCollectorSentinel.ConcurrentMarkSweep.heapUsagePercentage");
        gcMarkSweepHeapSettingSupplemental.setTitle(brand + "." + env + ".host." + treStatsSuppPoolShotName + ".*.GarbageCollectorSentinel.ConcurrentMarkSweep.heapUsagePercentage");
        ...
        gcMarkSweepTimeSettingNormal.setTarget(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ConcurrentMarkSweep.collectionTime");
        gcMarkSweepTimeSettingNormal.setTitle(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ConcurrentMarkSweep.collectionTime");
        ...
        gcMarkSweepTimeSettingSupplemental.setTarget(brand + "." + env + ".host." + treStatsSuppPoolShotName + ".*.GarbageCollectorSentinel.ConcurrentMarkSweep.collectionTime");
        gcMarkSweepTimeSettingSupplemental.setTitle(brand + "." + env + ".host." + treStatsSuppPoolShotName + ".*.GarbageCollectorSentinel.ConcurrentMarkSweep.collectionTime");
        ...
        gcParNewHeapSettingNormal.setTarget(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ParNew.heapUsagePercentage");
        gcParNewHeapSettingNormal.setTitle(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ParNew.heapUsagePercentage");
        ...
        gcParNewHeapSettingSupplemental.setTarget(brand + "." + env + ".host." + treStatsSuppPoolShotName + ".*.GarbageCollectorSentinel.ParNew.heapUsagePercentage");
        gcParNewHeapSettingSupplemental.setTitle(brand + "." + env + ".host." + treStatsSuppPoolShotName + ".*.GarbageCollectorSentinel.ParNew.heapUsagePercentage");
        ...
        gcParNewTimeSettingNormal.setTarget(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ParNew.collectionTime");
        gcParNewTimeSettingNormal.setTitle(brand + "." + env + ".host." + treStatsPoolName + ".*.GarbageCollectorSentinel.ParNew.collectionTime");
        ...
        gcParNewTimeSettingSupplemental.setTarget(brand + "." + env + ".host." + treStatsSuppPoolShotName + ".*.GarbageCollectorSentinel.ParNew.collectionTime");
        gcParNewTimeSettingSupplemental.setTitle(brand + "." + env + ".host." + treStatsSuppPoolShotName + ".*.GarbageCollectorSentinel.ParNew.collectionTime");
